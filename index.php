...
<div style="background-color: #ffffff; border-radius: 3px;border-bottom: 3px solid #116ab9; padding-top:5px; padding-left: 6px; position: absolute; width:100%;top:0px;">
  <img src='images/logo.png'style="float: left;padding: 10px 18px;width:80px; height:80px;"/><p style="letter-spacing: 3px;color: #454a4b;font-size:30px;padding-top:20px; text-align:center;">Belkien Company</p></center>
</div>
<br><br><br>

<div  align='center' style="padding-top:8%;">
<table><tr><td><h1><font color="#57575B">Login Panel</font><img src="images/av.png" style="width:80px; height:80px;"></h1>
</td></tr><tr><td><br/>
<input type="text" name="uname" maxlength="30" style="width: 100%;    padding: 12px 20px;    margin: 8px 0;    display: inline-block;    border: 1px solid #ccc;    border-radius: 4px;    box-sizing: border-box;" placeholder="    Username"  required>
<BR>
</td>
</tr><tr>
<td>
