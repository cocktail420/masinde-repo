...
<center>
  <u style="color:#21618c;"><h2 style="color:#21618c;">OB 2/3 Trimester USG Report</h2></u>
  <p align="left"style="padding-left:5%; padding-right:5%;">Real time B mode sonography of pelvis, showed Gravid uterus with Single/<br/>
    ...
    <table width="50%" align="center" style="border-collapse: collapse;" border="1">
      <tr>
        <td width="30%" style="border:1px solid #21618c; color:#21618c;">&emsp;<b>BPD </b></td>
        <td style="border:1px solid #21618c; color:#21618c;"><?php echo $bpd; ?></td>
        <td width="53%"style="border:1px solid #21618c; color:#21618c;">&emsp;<?php echo $bpdwd; ?></td>
      </tr>
      <tr>
        <td style="border:1px solid #21618c; color:#21618c;">&emsp;<b>HC</b></td>
        <td style="border: 1px solid #21618c; border-left:0px; color:#21618c"><?php echo $hc; ?></td>
        <td style="border:1px solid #21618c; color:#21618c;">&emsp;<?php echo $hcwd; ?></td>
      </tr>
      <tr>
        <td style="border:1px solid #21618c; color:#21618c;">&emsp;<b>AC</b></td>
        <td style="border:1px solid #21618c; color:#21618c;"><?php echo $ac; ?></td>
        <td style="border:1px solid #21618c; color:#21618c;">&emsp;<?php echo $acwd; ?></td>
      </tr>
      <tr>
        <td style="border:1px solid #21618c; color:#21618c;">&emsp;<b>FL</b></td>
        <td style="border:1px solid #21618c; color:#21618c;"><?php echo $fl; ?></td>
        <td style="border:1px solid #21618c; color:#21618c;">&emsp;<?php echo $flwd; ?></td>
      </tr>
    </table><br/>
    <table width="90%" align="center">
      ...
      <tr>
        <td>Liquor</td>
        <td>:-  &emsp;&emsp;<font style="padding:0px 10px; border-bottom:1px dashed;"><?php echo $liquor; ?></font></td>
      </tr>
      <tr>
        <td>AFI </td>
        <td>:- &emsp;&emsp;<font style="padding:0px 10px; border-bottom:1px dashed;" ><?php echo $afi; ?></font></td>
      </tr>
      <tr>
      ...
      <tr>
        <td><u style="color:#21618c;"><h2 style="color:#21618c;">IMPRESSION</h2></u></td>
      </tr>
      <tr>
        <td colspan="2">Single live intrauterine gestation corresponding to gestational age of <font style="padding:0px 10px; border-bottom:1px dashed;"><?php echo $geswks; ?></font> wks <font style="padding:0px 10px; border-bottom:1px dashed;"><?php echo $gesdays; ?></font> day. Gestational age assigned as per LMP. <br>Scan date: <?php echo date('d/m/Y',strtotime($scandte)); ?> </p></td>
      </tr>
      <tr>
    ...
    <tr>
      ...
      <tr>
        ...
        <td align="center" colspan="2">
          <p style="width: 100%;  bottom: 10px;letter-spacing:0px;  border-top: 1px solid #21618c; color:#21618c;" align="center">
            <i>
