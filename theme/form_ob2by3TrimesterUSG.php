             ...
             <form method="post" action="action.php">
               ...
               <table>
                 <tr>
                   ...
                   <td><input type="text" placeholder="WKS & D" name="bpdwd" value="0 wks & 0 days" required/></td>

                   <td align="right"><b>HC: </b></td>
                   <td><input type="text"pattern="[+-]?[0-9]+(.[0-9]+)?([Ee][+-]?[0-9]+)?" placeholder="HC" name="hc" required/></td>
                   <td><input type="text" placeholder="WKS & D" name="hcwd" value="0 wks & 0 days" required/></td>
                 </tr>
                 <tr>
                   <td align="right"><b>AC: </b></td>
                   <td><input type="text"pattern="[+-]?[0-9]+(.[0-9]+)?([Ee][+-]?[0-9]+)?" placeholder="AC" name="ac" required/></td>
                   <td><input type="text" placeholder="WKS & D" name="acwd" value="0 wks & 0 days" required/></td>

                   <td align="right"><b>FL: </b></td>
                   <td><input type="text" pattern="[+-]?[0-9]+(.[0-9]+)?([Ee][+-]?[0-9]+)?" placeholder="FL" name="fl" required/></td>
                   <td><input type="text" placeholder="WKS & D" name="flwd" value="0 wks & 0 days" required/></td>
                 </tr>
                 ...
                 <tr>
                  ...
                  <tr>
                    ...
                    <td><input type="text" name="minfo" value=" " required/></td>
                  </tr>
                  <tr>
                  ...
                  <tr>
                    <td colspan="2"><b>Scan date:</b></td>
                    <td><input type="date" name="scdte" required/></td>
                  </tr>
               </table><br/><br/>
               <br/>
