...
<center>
  ...
  <u style="color:#21618c;"><h2 style="color: #21618c;">Belkien Masinde Reports</h2></u>
  <p text-align="left" style="padding-left:5%;">On.<br/>

<table width="100%" >
  <tr>
    <td><font style="color: #21618c;"><b>date</b>:</font>   <?php if($lmp!=''){ echo date('d/m/Y',strtotime($lmp));} ?></td>
    <p>the Billiards Team, Office, received from </p>
    <!-- <td><font style="color: #21618c;"><b>name</b>(LMP)</font>:  <font style="padding:0px 10px; border-bottom:1px solid;"><?php echo $patient_namess; ?></font></td>
    <td><font style="color: #21618c;"><b>EDD</b>(LMP)</font>:  <font style="padding:0px 10px; border-bottom:1px solid;"><?php if($lmpeod!=''){echo date('d/m/Y',strtotime($lmpeod));} ?></font></td> -->
  </tr>
  <!-- <tr>
    <td></td>
    <td><font style="color: #21618c;"><b>GA</b>(USG)</font>:   <font style="padding:0px 10px; border-bottom:1px solid;"><?php echo $usgga; ?></font></td>
    <td><font style="color: #21618c;"><b>EDD</b>(USG):</font>  <font style="padding:0px 10px; border-bottom:1px solid;"><?php if($usgeod !=''){echo date('d/m/Y',strtotime($usgeod));} ?></font></td>
  </tr> -->
</table><br/>
  <!-- <u style="color: #21618c;"><b style="font-size:20px; color:#21618c;">Urinary bladder</b></u><br/>
<font style="padding-left:5%;">Is normal contour. No intraluminal echoes.</font><br/><br/>

<u style="color:#21618c; height:2px;"><b style="font-size:20px; color:#21618c;">Uterus</b></u><br/><br/>
...
<u style="color:#21618c;"><b style="font-size:20px; color:#21618c;">Ovaries</b></u><br/><br/>
...
<p align="left" style="padding-left:5%; padding-right:5%;"><u style="color:#21618c;"><b style="font-size:20px; color:#21618c;">Impression</b></u><br/><br/><font style="padding-Left:4%;">Single live intra uterine gestation corresponding to gestational age of <font style="padding:0px 10px; border-bottom:1px solid;"><?php echo $wk; ?></font> wks</font>
