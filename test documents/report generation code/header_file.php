    ...
    <div align="center">
      <table style="padding:20px 40px; cell-padding:0px 0px;" border="0" width="100%">
        <tr>
          ...
          <td align='center' style="font-size:22px;"><b>Belkien Masinde</b></td>

        </tr>
        <!-- <tr>
          <td align='center' style="font-size:22px;"><b>ample System,</b></td>
        </tr>
        <tr>
          <td align='center' style="font-size:22px;">No.61, Nairobi, Kenyas (632301).</td>
        </tr>
        <tr>
