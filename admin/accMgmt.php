          ...
          <div class="form-style-8" style="padding-top:0px;"><br/>
            ...
            <tr>
              <form action="updateacc.php" method="post">
                ...
                <td>
                  <input type="email" name="val" placeholder="e-mail Id" value="<?php echo $email; ?>" required/>
            ...
            <tr>
              <form action="updateacc.php" method="post">
                ...
                <td>
                  <input type="tel" pattern="[0-9]{10}" name="val" placeholder="Phone Number" value="<?php echo $phone; ?>" required/>
        ...
        <td style="padding-top: 0px;">
          <div class="form-style-8" style="padding-top:0px;">
            ...
            <form method="post" action="addUser.php">
              ...
              <input type="tel" pattern="[0-9]{10}" name="phone" placeholder="Phone" /><p style="color: #626364;"><b>Date of Birth(D.O.B)</b></p>
