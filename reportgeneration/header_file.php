    ...
    <div align="center">
      <table style="padding:20px 40px; cell-padding:0px 0px;" border="0" width="100%">
        <tr>
          ...
          <td align='center' style="font-size:26px;"><b>Belkien Masinde</b></td>

        </tr>
        <!-- <tr>
          <td align='center' style="font-size:22px;"><b>Sample Center,</b></td>
        </tr>
        <tr>
          <td align='center' style="font-size:20px;">No.2834849 (632xxx).</td>
        </tr>
        <tr>
          <td align='center' style="font-size:20px;">Reg No.: 77898</td>
        </tr> -->
      </table>
