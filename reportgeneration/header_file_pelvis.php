  ...
  <body>
    ...
    <div align="center">
      <table style="padding:20px 40px; cell-padding:0px 0px;" border="0" width="100%">
        ...
        <tr>
          <td align='center' style="font-size:22px;"><b>Sample CENTRE,</b></td>
        </tr>
        <tr>
          <td align='center' style="font-size:20px;">No.345 (632).</td>
        </tr>
        <tr>
          <td align='center' style="font-size:20px;">Reg No.: 233435</td>
        </tr>
      </table>
