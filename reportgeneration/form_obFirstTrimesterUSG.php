       ...
       <div class="form-style-8 scroll" style="width: 90%;padding-top:0px;">
             ...
             <form method="post" action="action.php">
               <table>
                 ...
                 <tr>
                   <td><input type="text" name="indication" placeholder="content" required /></td>
                   <td><b>Number ID: <?php
                   $sn=0;
                   ...
                   <td><b>Content Owner:</b>&emsp;&emsp;&emsp;Front Office Mr. Ochieng<input type="hidden" name="study" value="Obstetrics"><input type="hidden" name="rkey" value="<?php echo $rkey; ?>"></td>
                 </tr>
               </table><br/><br/>
               <h6>other details</h6>
               <table>
                 <tr>
                   ...
                   <td><b>GA(LMP): </b></td><td><input type="text" id="galmpauto" name="galmp" required/></td>
                 ...
                 <tr>
                   ...
                   <td></td>
                   <td><b>GA(USG):</b></td>
                   <td><input type="text" name="gausg" required/></td>
                   <td><b>EOD(USG):</b></td>
